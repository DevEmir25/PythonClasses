"""
1 - veri isimli klasörü oluşturun
2 - zip dasyasini veri klasoreune cikartin
3 - zip dosyasi icindeki csv dosyalarinin tum icerigini tek bir csv dosyasinda birlestirin volume olmasin
4 - bu kayitlarin tamamini sqlite veritabanina bir tablo olusturarak yukleyin
5 - kullanicinin belirlediği paritenin kullanicinin belirlediği araligin kullanicinin belirlediği degerin grafigini cizdirin.
  (veriler sqlite tan cekilecek)
